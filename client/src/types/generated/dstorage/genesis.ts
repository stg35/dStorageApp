...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, systemInfo: undefined, storedFileList: [] };
}
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      systemInfo: isSet(object.systemInfo)
        ...
        : undefined,
      storedFileList: Array.isArray(object?.storedFileList)
        ? object.storedFileList.map((e: any) => StoredFile.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.storedFileList =
      object.storedFileList?.map((e) => StoredFile.fromPartial(e)) || [];
    return message;
  },
};
