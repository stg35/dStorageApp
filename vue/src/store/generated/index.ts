...
import DfsappDstorageDfsappDstorageDstorage from './dfsapp/dstorage/dfsapp.dstorage.dstorage'
...
export default { 
  ...
  DfsappDstorageDfsappDstorageDstorage: load(DfsappDstorageDfsappDstorageDstorage, 'dfsapp.dstorage.dstorage'),
